...
!  *                       (!) NON OFFICIAL CODE (!)                        *
!  *                                                                        *
!  *         BUILDING PROFILE INPUT PROGRAM for PRIME(DATED 24244)          *
!  *                                                                        *
...
!                       Div. Atm. Chemistry, CNEA.    
!                       email: espada(at)agro.uba.ar  
!                       CAC, Buenos Aires, Argentina. 
!
!  **************************************************************************
!
...
!  **************************************************************************
      ...
      type tier
        ...
        real,allocatable :: xy2(:,:)                                    !rotated coords      (changes for each wdir)
      ...
      !Calc "new" (rotated) coordinates: xy --> xy2
          ...
          !stack
          do i=1,size(S)
             S(i)%xy2=matmul(R,S(i)%xy)                                 !rotated stack coordinates
          enddo
          !buildings
          do i=1,size(B)
             do j=1,size(B(i)%T)
